package br.ederlima.ui.styles 
{
	...
	public class ListItemStyle 
	{
		...
		private var _textFormat:TextFormat = new TextFormat("Arial", "11", 0xF0F0F0);
		private var _backgroundColor:String = "FFFFFF";
		private var _alternateColor:String = "F0F0F0";
		/**
		...
		public function ListItemStyle(textFormat:TextFormat = null, backgroundColor:String = "", alternateColor:String = "", primaryIcon:MovieClip = null) 
		{
			...
			/*_alternateColor = "CCFFFF";
			_backgroundColor = "DDFFFF";*/
		}
